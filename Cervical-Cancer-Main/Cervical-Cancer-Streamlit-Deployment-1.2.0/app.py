...
st.markdown(
    ...
    <style>
      ...
      html, body, [data-testid="stAppViewContainer"], .stApp {
        ...
        overflow: hidden !important;   /* no outer page scrollbar, ever */
      }
      [data-testid="stAppViewContainer"] > .main { padding: 0 !important; height: 100vh !important; overflow: hidden !important; }
      .block-container { max-width: 100% !important; padding: 0 !important; margin: 0 !important; height: 100vh !important; }
      [data-testid="stVerticalBlock"] { gap: 0 !important; }
      iframe { display: block; border: 0 !important; height: 100vh !important; }
      /* Belt-and-suspenders: hide any scrollbar Streamlit itself might add */
      * {
