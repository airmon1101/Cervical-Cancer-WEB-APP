(() => {
  ...
  function setFrameHeight() {
    const fullPageHeight = Math.max(document.documentElement.scrollHeight, (window.screen && window.screen.availHeight ? window.screen.availHeight - 70 : 800));
    sendMessage("streamlit:setFrameHeight", { height: fullPageHeight });
  }
